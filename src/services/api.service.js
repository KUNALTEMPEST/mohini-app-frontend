...
export async function getAI4BharatAudio(text, sourceLanguage = 'en', gender = 'female') {
    try {
    let storedRoute = bot_routes.shikshalokam_chaupal;
...
export async function ai4BharatASR(base64, sourceLanguage = 'en', storedRoute = bot_routes.shikshalokam_chaupal) {
