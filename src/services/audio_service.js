...
export const handleOnSpeaking = async (text, id, sourceLanguage, audioRef, audioCache, setAudioCache, setIsPlaying) => {
    try {
      try {
...
export const startRecording = (
    ...
    const handleInputChange = ({ value, maxLength }) => {
        ...
        if (isNumber) {
            const spokenConverted = spokenWordsToDigits(newValue);
...
export const handleAI4BharatTTSRequest = async (text, id, sourceLanguage='en', audioCache, audioRef, setAudioCache, setIsPlaying) => {
    try {
